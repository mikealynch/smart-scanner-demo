...
if uploaded_file is not None:
    try:
        ...
        Now, we take the detected text and send it to **OpenAI's GPT model** to format the data into a **JSON structure**. The goal is to extract key fields such as:
        
        - **Name**
        - **Email**
        - **Phone number**
        
        This step allows us to clean up the extracted information and organize it in a way that's easy to work with.
        """)
        ...
        st.markdown("""
                    This is my AI prompt. It contains text as well as  text generated by our OCR tool: 
""")
